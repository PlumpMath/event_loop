...
struct ns_connection {
  ...
  ns_callback_t handler;     // Protocol-specific event handler //ywhwang ADD for UDP packet
#endif
...
#define NSF_USER_11                (unsigned int)(1 << 30)
#define NSF_USER_12                (unsigned int)(1 << 31)
};
